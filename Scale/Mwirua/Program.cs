...
namespace Test
{
    static class Program
    {
        ...
        {        
            ...
            Coffee.client.connectedtomain = true;

            var d = new Coffee.coffee();
            Coffee.coffee.Factory_Name = "MWIRUA FCS LIMITED";
            ...
            //var view = new Coffee.Stores_List();
            //var repository = new Coffee.Repository();
            //var presenter = new Coffee.CustomerPresenter(view, repository);
