    ...
    public class Agency : System.Web.Services.WebService
    {
        ...
        public void Member(string login)
        {
            ...
            try
            {
                ...
                AGENCY_BANKINGEntities db = new AGENCY_BANKINGEntities();
        ...
        public void Login(string login)
        {
            ...
            try
            {
                ...
                var db = new Data.AGENCY_BANKINGEntities();
        ...
        public void Changepin(string data)
        {
            ...
            try
            {
                ...
                var db = new AGENCY_BANKINGEntities();
        ...
        public void Accounts(string data)
        {
            ...
            try
            {
                ...
                if (trans.member_1 != null)
                {
                    ...
                    using (var db = new Data.AGENCY_BANKINGEntities())
                    {
        ...
        public void Transactions(string data)
        {
            ...
            {
                tr = JsonConvert.DeserializeObject<Transaction>(data);
                using (var localdb = new AGENCY_BANKINGEntities( ))
                {
                    switch (tr.status)
                    {
                        case Transaction.Status.Pending:
                            {
                                ...
                                try
                                {
                                    ...
                                    if (agt == null)
                                    {
                                        ...
                                        agt.Document_No = "";
                                        localdb.Agency_Transactions.Add(agt);
                                        localdb.SaveChanges();
                                    }
                        ...
                        case Transaction.Status.Confirmation:
                            {
                                ...
                                if (t != null)
                                {
                                    try
                                    {
                                                ...
                                                if (tr.member_1 != null)
                                                    if (tr.account_1.Telephone != null)
                                                    {
                                                        ...
                                                        if (agm == null)
                                                        {
                                                            ...
                                                            localdb.Agency_Members.Add(agm);
                                                            localdb.SaveChanges();
                                                        }
                                        ...
                                        sms.Send(sms); AgencyTransactions.AgentTransactions trans = new AgencyTransactions.AgentTransactions();
        ...
        CUtilities.LogEntryOnFile(ex.Message);
                CUtilities.LogEntryOnFile(ex.StackTrace);
                CUtilities.LogEntryOnFile(ex.InnerException.StackTrace);
            }
            finally {
...
Context.Response.Output.Write(response);
        ...
        public static string ConnectionString()
        {
            ...
            sqlBuilder.InitialCatalog = "AGENCY BANKING";// settings.s.database;
