...
class LoanEntriesRequest {
  String? loanNo;

  LoanEntriesRequest({this.loanNo});
  ...
  factory LoanEntriesRequest.fromMap(Map<String, dynamic> map) {
    return LoanEntriesRequest(
  ...
  factory LoanEntriesRequest.fromJson(String source) =>
      LoanEntriesRequest.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class LoanEntry {
  ...
  DateTime? get postingDate {
    if (Posting_Date == null) return null;
    try {
      return DateTime.parse(Posting_Date!.replaceAll('/', '-'));
    } catch (e) {
      return null;
    }
  }
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'Initial_Entry_Due_Date': Initial_Entry_Due_Date,
  ...
  factory LoanEntry.fromMap(Map<String, dynamic> map) {
    return LoanEntry(
      ...
      Posting_Date:
          map['Posting_Date'] != null ? map['Posting_Date'] as String : null,
      ...
      Credit_Amount_LCYSpecified: map['Credit_Amount_LCYSpecified'] != null
          ...
          : null,
      Initial_Entry_Due_Date: map['Initial_Entry_Due_Date'] != null
          ? map['Initial_Entry_Due_Date'] as String
          : null,
  ...
  factory LoanEntry.fromJson(String source) =>
      LoanEntry.fromMap(json.decode(source) as Map<String, dynamic>);
}

class LoanEntriesResults {
  int? Code;
  String? Desc;
  List<LoanEntry>? Contents;
  ...
  factory LoanEntriesResults.fromMap(Map<String, dynamic> map) {
    return LoanEntriesResults(
      Code: map['Code'] != null
          ? (map['Code'] is double
      ...
      Contents: map['Contents'] != null
          ? List<LoanEntry>.from(
              (map['Contents'] as List).map<LoanEntry?>(
                (x) => LoanEntry.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
    );
  ...
  factory LoanEntriesResults.fromJson(String source) =>
      LoanEntriesResults.fromMap(json.decode(source) as Map<String, dynamic>);
}
