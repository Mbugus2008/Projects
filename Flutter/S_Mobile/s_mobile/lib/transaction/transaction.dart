...
class Transaction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'Document_Date': Document_Date?.toIso8601String(),
      'Transaction_Time': Transaction_Time?.toIso8601String(),
      'Account_Balance': Account_Balance,
      'Transaction_Type': Transaction_Type?.index,
      'Telephone_Number': Telephone_Number,
      'Posted': Posted,
      'Date_Posted': Date_Posted?.toIso8601String(),
      'Account_2': Account_2,
      'Status': Status?.index,
      'Loan_No': Loan_No,
      'Comments': Comments,
      ...
      'Statement_From': Statement_From?.toIso8601String(),
      'Statement_to': Statement_to?.toIso8601String(),
      'Email': Email,
    };
  }
