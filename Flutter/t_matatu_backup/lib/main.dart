...
import 'package:t_matatu/providers/clients/EmbaShuttle.dart';
...
class start {
      ...
      case "02":
        {
          ...
          case "03":
        {
          Get.find<MainController>().CurrentClient = EmbaShuttle().obs;
        }
    }
  ...
  Future<void> initiate() async {
    //Get.find<MainController>().config?.value =
    //    (await AppConfig.loadConfig(clientId))!;
