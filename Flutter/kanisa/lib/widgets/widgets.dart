      ...
      children: [
          ...
          items: imgList.map((item) => Container(
            child: Center(
              child:ClipPath(
                ...
                child: Card(shadowColor: Colors.blue, elevation: 10,
                  child: Image.asset(
                    item,
                    fit: BoxFit.cover,
        ...
        Row(
          ...
          children: imgList.asMap().entries.map((entry) {
            return Obx(()=>
                GestureDetector(
                  onTap: () => Get.find<ImageSliderController>().changeImage(entry.key),
                  child: Container(
                    width: 10.0,
                    height: 10.0,
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Get.find<ImageSliderController>().currentImageIndex == entry.key
                          ? Colors.blueAccent
                          : Colors.grey,
                    ),
                  ),
