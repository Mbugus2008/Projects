...
class Daysreport extends StatelessWidget {
  const Daysreport({super.key});
                                ...
                                leading: (reversed == false &&
                                    ...
                                    ? SizedBox(
                                        child: IconButton(
                                          ...
                                          onPressed: () async {
                                            List<int>? bytes = await Get.find<MainController>().CurrentClient?.value.printReceipt(Get.find<ReportController>().daystrans[index]);
                                            if (bytes != null)
                                    ...
                                    Text(
                                        Get.find<MainController>()
                                            ...
                                            .v_description(
                                                Get.find<ReportController>()
                                                    .daystrans[index]),
                                        //'${Get.find<ReportController>().daystrans[index].Vehicle ?? ''}- ${Get.find<ReportController>().daystrans[index].Fleet}',
