...
public final class TypefaceHelper {
	 ...
	 * @param strResId string resource containing typeface name.
	 */
	public <F extends Fragment> void supportSetTypeface(F fragment, @StringRes int strResId) {
	 ...
	 * @param style the typeface style.
	 */
	public <F extends Fragment> void supportSetTypeface(F fragment, @StringRes int strResId, int style) {
