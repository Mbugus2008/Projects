...
namespace NyalaVision.Controllers
{
    /// <summary>
    /// Nav Integration API
    /// </summary>
    public class SaccoController : ApiController
    {
        ...
        Accounts_Service.Accounts_Service accounts = new Accounts_Service.Accounts_Service();
        Transactions.Transactions_Service transactions = new Transactions.Transactions_Service();
        Loans.Loans_mobile_Service loans_Mobile = new Loans.Loans_mobile_Service();
        Smobile.Mobile mobile = new Smobile.Mobile();
        Agent_App.Agent_App_Service Agent_App_Service = new Agent_App.Agent_App_Service();
        Account_Entries.Account_Entries_Service Account_Entries_Service = new Account_Entries.Account_Entries_Service();
        Member_Application.Member_Application_Service Application_Service = new Member_Application.Member_Application_Service();
        Account_Types.Account_Types_Service Account_Types_Service = new Account_Types.Account_Types_Service();
        Members.mobile_Member_Service member_Service = new Members.mobile_Member_Service();
        Nextofkin.Nextofkin_Service Nextofkin_Service = new Nextofkin.Nextofkin_Service();
        Mobile_Loan_Entries.Mobile_Loan_Entries_Service Loan_Entries_Service = new Mobile_Loan_Entries.Mobile_Loan_Entries_Service();

        Relationshiptypes.Relationshiptypes_Service Relationshiptypes_Service = new Relationshiptypes.Relationshiptypes_Service();
        Eligibility.Eligibility_Service _eligibility = new Eligibility.Eligibility_Service();

        LoanProducts.LoanProducts_Service LoanProducts_Service = new LoanProducts.LoanProducts_Service();
        Guarantors_Mobile.Guarantors_Mobile_Service Guarantors_Mobile_Service = new Guarantors_Mobile.Guarantors_Mobile_Service();
        /// <summary>
        /// 
        /// </summary>
        ...
        public Results<List<Accounts_Service.Accounts>> Accounts([FromBody] Params Phone)
        {
            ...
            try
            {
                ...
                if  (acc!=null)
                r.Contents = accounts.ReadMultiple(new Accounts_Service.Accounts_Filter[] { new Accounts_Service.Accounts_Filter { Criteria = acc.Member_No, Field = Accounts_Service.Accounts_Fields.Member_No } }, null, 0).ToList();
            }
            catch (Exception ex)
            {
                Logging.Logging.ReportError(ex);
        ...
        [HttpPost]
        [Route("api/account")]
        public Results<Accounts_Service.Accounts> Account([FromBody] string acc)
        {
            Results<Accounts_Service.Accounts> r = new Results<Accounts_Service.Accounts>();
            try
            {
                r.Contents = accounts.Read(acc);
            }
            catch (Exception ex)
            {
                Logging.Logging.ReportError(ex);
                ...
                if (t == null)
                {
                    ...
                    if (trans.Code == 0 && trans.Transaction_Type == Transactions.Transaction_Type.Loan_Ministatement)
                    {
                        ...
                        foreach (var account_Entries in ent)
                        {
                            ...
                            m.desc = account_Entries.Description;
                            m.amount = Math.Abs((double)account_Entries.Amount);
                            m.Transaction_Type = account_Entries.Transaction_Type.ToString();
                            if (account_Entries.Amount > 0)
                                m.dr_cr = "DR";
                            else
                                m.dr_cr = "CR";
...
public string Loan_No { get; set; }
    ...
    namespace NyalaVision.Accounts_Service
    {
    ...
    namespace NyalaVision.Transactions
    {
...
namespace NyalaVision.Accounts_Service {
    ...
    [MetadataType(typeof(account_annotations))]
    public partial class Accounts
    {


    }
    public class account_annotations {
       
        [DefaultValue("")]
        public object Agent_Code;
        }
}