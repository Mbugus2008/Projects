...
namespace Sacco.Server.Controllers
{
    ...
    public class GuaranteedController : ControllerBase
    {    
        
        private readonly ILogger<LoansController> _logger;
        guarantorsdata.Guarantors_PortClient guarantors;
        public GuaranteedController(ILogger<LoansController> logger, IConfiguration configuration)
        {
        ...
        public IEnumerable<guarantorsdata.Guarantors> Get(string No)
        {
            ...
            return Guarantors.ReadMultiple(new Guarantors_Filter[] { new Guarantors_Filter { Criteria = No, Field = Guarantors_Fields.Member_No } },null,0);
