                ...
                try
                {
                    ...
                    if (m != null)
                    {
                        ...
                        if (string.IsNullOrEmpty(m.Phone_No) == false)
                        {
                            ...
                            sms.Sendsms(DateTime.Now.Ticks.ToString(), m.Phone_No, string.Format("Dear {0}, Your Portal password was successfuly reset, new password: {1}.", m.Name, Password), "10000");
