...
public class Realestatefund extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newfund.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Realestatefund.this, addeditfund.class);
    ...
    private class getadapterdata extends AsyncTask<Void, Void, List<RealEstate>> {
        ...
        protected void onPostExecute(List<RealEstate> res) {
            if(res.size()>0) {
                ...
                RealEstate.adapter    adapter = new RealEstate.adapter(Realestatefund.this);
