...
import static com.trimline.paul.transporter.BTDeviceList.REQUEST_CONNECT_BT;
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (farmers != null) {
                                            if (!kg.getText().toString().equals("")) {
                                                ...
                                                if ((c.Device_Id ==null) || (c.Device_Id.equals(""))) {
                                                    Log.i("No id","No id");
                                                    c.Device_Id = android.provider.Settings.Secure.getString(getApplicationContext().getContentResolver(), android.provider.Settings.Secure.ANDROID_ID);
                                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.summaryreport: {
                ...
                Intent summary = new Intent(getApplicationContext(), com.trimline.paul.transporter.summary.class);
            ...
            case R.id.farmercollection: {
                ...
                Intent summary = new Intent(getApplicationContext(), farmercollection.class);
                startActivity(summary);
    ...
    private class Getcollections extends AsyncTask<Summaries.getdata, Void, List<Collection>> {
        ...
        protected List<Collection> doInBackground(Summaries.getdata... params) {
            ...
            try {
                ...
                result = JsonParser.postjson("GetCollectionstransporter", "data", result);
