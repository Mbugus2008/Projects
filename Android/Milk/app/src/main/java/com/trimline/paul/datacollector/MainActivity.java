...
//new Getfarmer(farmerno.getText().toString()).execute();
        ...
        new Getfarmers(db.getFarmer(getpreferences("Transporter"))).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
            ...
            try {
                while (true) {
                    ...
                    if (!sending) {
                        ...
                        new sendpendingcollection(db.getpendingCollection()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                        this.sleep(5000);
                    }
                }
            } catch (Exception ex) {
