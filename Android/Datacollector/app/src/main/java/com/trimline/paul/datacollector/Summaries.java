...
import static com.trimline.paul.datacollector.Summaries.printer.printThread;
import static com.trimline.paul.datacollector.Summaries.printer.printerdevice;
import static com.trimline.paul.datacollector.Summaries.printer.printerin;
import static com.trimline.paul.datacollector.Summaries.printer.printerout;
import static com.trimline.paul.datacollector.Summaries.printer.printersock;
import static com.trimline.paul.datacollector.Summaries.scale.scaleThread;
import static com.trimline.paul.datacollector.Summaries.scale.scaledevice;
import static com.trimline.paul.datacollector.Summaries.scale.scalein;
import static com.trimline.paul.datacollector.Summaries.scale.scaleout;
import static com.trimline.paul.datacollector.Summaries.scale.scalesock;
                            ...
                            while (true) {
                                if ((mmSocket.isConnected())) {
                                  //  Log.i("Reading data", "Data reading");
                                    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(scalein));

                                    String line;
                                    while ((line = bufferedReader.readLine()) != null) {
                                        System.out.println("Received: " + line);
                                        mHandler.obtainMessage(Constants.MESSAGE_READ, line.toString()).sendToTarget();
                                        // Add your processing logic here for each received line

                                        // Example: If you want to send a response back to the client
                                        // PrintWriter out = new PrintWriter(clientSocket.getOutputStream(), true);
                                        // out.println("Response to the client");
                                    }
...
//                                    }
                    ...
                    mHandler.obtainMessage(Constants.MESSAGE_TOAST, "Scale Not set").sendToTarget();
                    return;}
            } catch (Exception ex) {
                ex.printStackTrace();
