...
import com.trimline.paul.m_branch.transactions.GroupedByVehicle;
import com.trimline.paul.m_branch.transactions.GroupedByType;
import com.trimline.paul.m_branch.transactions.GrouptransListAdapter;
        ...
        if (v == null) {
            if (vehno.getText().toString().contains("..") || vehno.getText().toString().contains("|")) {
                if (vehno.getText().toString().contains("..")) {
                    ...
                    List<vehicles> vhs = db.getvehicleslist(placeholders);
                ...
                veh = vehno.getText().toString();
        }
        else
            veh = v.Vehicle_Number;
            ...
            try {
                for (vehicles v : db.getvehicles()
                    ...
                    if (v.Vehicle_Number != null)
                        clients.add(v.Vehicle_Number + " - " + v.Code );
                ...
                if (res != null)
                    if (res.size() > 0) {
                        ...
                        for (GroupedByVehicle g:groupedByLoanNoList
                            ...
                            g.setFleetNO(db.getvehicle(g.getVehicle()).Vehicle_Number);
                        }
