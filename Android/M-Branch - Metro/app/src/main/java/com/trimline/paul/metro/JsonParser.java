...
public class JsonParser {
    ...
    public static Response postData(String baseUrl, String endpoint, String jsonData, String clientId) throws IOException {
        // Build the full URL
        String url = baseUrl + endpoint;
        Log.i("API", "URL: " + url);
        Log.i("API", "out: " + jsonData);

        // Build headers
        Headers headers = new Headers.Builder()
                .add("Content-Type", "application/json")
                .add("X-Client-Identifier", clientId != null ? clientId : "")
                .build();
        ...
        // Execute synchronously (call.enqueue for async)
        Response response = client.newCall(request).execute();

        Log.i("API", "url: " + endpoint + ", status code: " + response.code());
        String responseBody = response.body() != null ? response.body().string() : "";
        Log.i("API", "url: " + endpoint + " body: " + responseBody);
