...
public class agentcollections extends AppCompatActivity {
    DB db = null;
      ...
      Calendar  cdt=Calendar.getInstance();
        ...
        recoverydate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(agentcollections.this,
...
//dd-MM-yyyy
    ...
    private class getclients extends AsyncTask<Void, String, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String> res) {
            try {
                AutoSuggestAdapter adapter = new AutoSuggestAdapter(agentcollections.this, android.R.layout.simple_list_item_1, res);
...
//                        }
                ...
                GrouptransListAdapter adapter = new GrouptransListAdapter(agentcollections.this, groupedByLoanNoList);
