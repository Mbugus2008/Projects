...
import com.trimline.paul.m_branch.types;
...
double globaltotal =0;
        ...
        protected void onPostExecute(Void res) {
            try {
                if (progress.isShowing())
                    progress.dismiss();
                listAdapter = new Receipts(receipts.this, listDataHeader, listDataChild, db);
    ...
    public static class Receipts extends BaseExpandableListAdapter {
