...
import static com.trimline.paul.m_branch.summaries.printer.printThread;
import static com.trimline.paul.m_branch.summaries.printer.printerdevice;

import static com.trimline.paul.m_branch.summaries.printer.printerout;
import static com.trimline.paul.m_branch.summaries.printer.printersock;
...
//                        data += tt.typename + ":" + String.format("%-" + (22 - tt.typename.length()) + "s", "") + tt.Amount.toString() + "\n";
        ...
        public String printout(String header,String value) {
            ...
            if ((header.length() + value.length()) < 31)
            return header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
            else {
                String value2 = value.substring(0, 30 - header.length());
                System.out.println(header + value);
                return header + String.format("%" + (31 - (header.length() + value2.length())) + "s", space) + value2 + "\n";
            }        }
