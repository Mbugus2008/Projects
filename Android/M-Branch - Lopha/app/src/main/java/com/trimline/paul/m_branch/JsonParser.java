...
public class JsonParser {
    ...
    public static String WEBSERVICE_URL2 = "http://localhost:8344/api";
    ...
    public static String postjson2(String Method, String param, String json) {
        StringBuilder result = new StringBuilder();
        try {
            Log.i("sendingurl", "here");
            String value = preferences.getString("IP", "");
            //URL url = new URL("Http://" + value + WEBSERVICE_URL + "/" + Method);
            URL url = new URL( WEBSERVICE_URL2 + "/" + Method);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            String urlParameters = param + "=" + json;
            connection.setInstanceFollowRedirects(true);
            connection.setRequestMethod("POST");
