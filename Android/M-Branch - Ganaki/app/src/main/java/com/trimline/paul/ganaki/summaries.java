...
import static com.trimline.paul.ganaki.summaries.printer.printThread;
import static com.trimline.paul.ganaki.summaries.printer.printerdevice;

import static com.trimline.paul.ganaki.summaries.printer.printerout;
import static com.trimline.paul.ganaki.summaries.printer.printersock;
...
//    }
    public static class printer {
        ...
        public void printSummary( transaction t) {
            try {
                ...
                data += "--------------------------------\n";
                data +=printout( "Loan:",  String.format("%.2f",t.Loan));
                data +=printout( "Stage:",  String.format("%.2f",t.Stage));
                data +=printout( "Shares:",  String.format("%.2f",t.Shares));
                data +=printout( "Welfare:",  String.format("%.2f",t.Welfare));
                data +=printout( "Savings:",  String.format("%.2f",t.Savings));
                data +=printout( "Court Board:",  String.format("%.2f",t.Court_Bond));
                data +=printout( "Operation:",  String.format("%.2f",t.Operation));

                data += "--------------------------------\n";
                data += printout("Total", String.format("%.2f", t.Amount) )+ "\n";
        ...
        public void printcollectionlist(Bitmap logo, List<transaction> t) {
            try {
        ...
        public void printcollection(Bitmap logo, transaction t) {
            try {
                ...
                String data = "";
                data = "--------------------------------\n";
                header = "Ref:"; value = t.OTTN;
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                header = "M. No::"; value = t.Account_No;

                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";

                header = "Vehicle:"; value = t.Loan_No;
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";

                header = "Date:"; value = t.Date;
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";

                header = "Time:"; value = t.Time;
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";

                data += "--------------------------------\n\n";
                header = "Operation  :"; value =String.format("%.2f",t.Operation);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";

                //data += "Stage cash :  " + String.format("%.2f",t.Stage) + "\n";
                header = "Stage cash"; value =String.format("%.2f",t.Stage);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                //data += "Welfare    :  " + String.format("%.2f",t.Welfare) + "\n";
                header = "Welfare"; value =String.format("%.2f",t.Welfare);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                //data += "Court Bond :  " + String.format("%.2f",t.Court_Bond) + "\n";
                header = "Court Bond"; value =String.format("%.2f",t.Court_Bond);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                //data += "Shares     :  " + String.format("%.2f",t.Shares) + "\n";
                header = "Shares"; value =String.format("%.2f",t.Shares);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                //data += "Loan       :  " + String.format("%.2f",t.Loan) + "\n";
                header = "Loan"; value =String.format("%.2f",t.Loan);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                //data += "Savings    :  " + String.format("%.2f",t.Savings) + "\n";
                header = "Savings"; value =String.format("%.2f",t.Savings);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
                data += "--------------------------------\n";

                //data += "TOTAL      :  " + String.format("%.2f",t.Amount) + "\n\n";
                header = "TOTAL"; value =String.format("%.2f",t.Amount);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n\n";
                //data += "Served by  :  " + Myvariables.CurrentAgent.Name + "\n\n\n\n\n";
                header = "Served by"; value =Myvariables.CurrentAgent.Name;
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n\n";
                try {
                    Thread.sleep(100);
                } catch (InterruptedException e) {
        ...
        public void printfuel(Bitmap logo, transaction t) {
            try {
                ...
                data += "--------------------------------\n\n";
                header = "Fuel  :"; value =String.format("%.2f",t.Amount);
                data += header + String.format("%" + (31 - (header.length() + value.length())) + "s", space) + value + "\n";
