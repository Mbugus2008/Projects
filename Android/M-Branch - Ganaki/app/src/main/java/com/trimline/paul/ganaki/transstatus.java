...
b.append(Html.fromHtml(String.format("Stage:        <b>%,.2f</b>\n",coll.get(paramInt).Stage)));
b.append(Html.fromHtml(String.format("Court Bond:   <b>%,.2f</b>",coll.get(paramInt).Court_Bond)));
        collno.setText(b.toString());
