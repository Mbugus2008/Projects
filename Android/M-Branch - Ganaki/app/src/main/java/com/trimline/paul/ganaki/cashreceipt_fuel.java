...
public class cashreceipt_fuel extends AppCompatActivity {
    EditText amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cashreceipt_fuel);
                ...
                try {
                    ...
                    if (t.Code != null)
                        if (t.Attach_to_vehicle) {
                            ...
                            vehicleAdapter = new ArrayAdapter<vehicles>(cashreceipt_fuel.this, android.R.layout.simple_spinner_item, mvehicles);
                    ...
                    if (t.Code.equals("LOAN")) {
                        ...
                        loanAdapter = new ArrayAdapter<loan>(cashreceipt_fuel.this, android.R.layout.simple_spinner_item, db.getcustomerloans(f.No));
...
//                }
        ...
        AutoSuggestAdapter adapter = new AutoSuggestAdapter(cashreceipt_fuel.this, android.R.layout.simple_list_item_1, Myvariables.vehs);
            ...
            public void onClick(View v) {
                try {
                    if (T != null) {
                        db.post(T);
                        Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.logo);
                        p.printcollectionlist(b, db.gettransbybatch(Batch));
                        clearfarmer();
                        cleartrans();
                        lastbatch = Batch;
                        T = new transaction();
        ...
        addtrans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (list.size() > 0) {
                        new AlertDialog.Builder(cashreceipt_fuel.this)
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        ListAdapter fc = new trans(cashreceipt_fuel.this, tt, db);
        ...
        if (ContextCompat.checkSelfPermission(this, WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, WRITE_EXTERNAL_STORAGE)
                ...
                alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(cashreceipt_fuel.this, new String[]{WRITE_EXTERNAL_STORAGE
...
// No explanation needed, we can request the permission.
    ...
    private class getclients extends AsyncTask<Void, String, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String> res) {
            try {
                AutoSuggestAdapter adapter = new AutoSuggestAdapter(cashreceipt_fuel.this, android.R.layout.simple_list_item_1, res);
                memberno.setAdapter(adapter);
...
//            try {
//                if (f!=null) {
//                    String loans = String.format("Loan Arrears: <b>%s</b>  " +
//                                    " Last Payment :<b>%s</b><br/>" +
//                                    "Savings: <b>%s</b> " +
//                                    "Last Payment: <b>%s</b><br/>" +
//                                    "Xmas: <b>%s</b>  " +
//                                    "Last Payment: <b>%s</b>", String.format("%,.2f", f.Loan_Arrears + f.dailyrepayment),
//                            f.Last_update_Loan, String.format("%,.2f", (f.Savings >= 0 ? 0 : f.Savings)),
//                            f.Last_update_savings, String.format("%,.2f", (f.Xmas >= 0 ? 0 : f.Xmas)), f.Last_update_xmas);
...
//                                f.Last_update_savings, String.format("%,.2f",  f.Xmas), f.Last_update_xmas);
//
//                    loanbalance.setText(Html.fromHtml(loans));
//
...
//
//                            //penalty.setText("Penalty: " + veh.Penalty);
//                            operationcost.setText(Html.fromHtml(String.format("Operation: <b>%s</b>", String.format("%,.2f", vv.get(0).Arrears))));
//
//                        }}
//            } catch (Exception ex) {
//                ex.printStackTrace();
