...
namespace SmsService
{
    ...
    public class Service1 : IService1
    {
      ...
      public   Delivery delivery(string s)
        {
            Logging.Logging.LogEntryOnFile(s);
            return null;
        }
        public int Sendsmsclassic( string phone, string text, string Client)
        {
            sms s = new sms();
