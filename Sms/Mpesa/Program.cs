...
namespace Mpesa_Sand
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            c.ShortCode = "4018311";
            c.confirmurl = "https://167.86.120.230:855/Deposit.svc/ConfirmC2BPayment";
            c.validateurl = "https://167.86.120.230:855/Deposit.svc/ValidateC2BPayment";

            //var auth = new MpesaApi.MpesaApi(c).auth(); 
            // stkpush();
            // live.registerurl(c);
            // live.test();
            // aouth = auth();
            ...
            //     r.CallBackURL = "https://167.86.120.230:855/Deposit.svc/stkpush";
            ...
            r.Amount = 100;
            r.PartyA = "3012507";
            r.PartyB = "254710563359";// string.Format("254{0}", loan.Mobile.Substring(loan.Mobile.Length - 9));
       ...
       var mp=     m.b2c(r);
        ...
        public static Auth auth()
        {
            ...
            string app_key = "ssM71J77oqIZCRqzfqhkldIt1myd2yqI";
            string app_secret = "Z5jIsL5RTByWwDgw";
        ...
        public static stkresponse stkpush() {
            ...
            try
            {
                ...
                string passkey = "8d777e028006665355e1ee4d11a1a0e656ad53c2085f7bd63c5b0d8417e06ab9";
       ...
       public static B2cResponse b2c() {
            ...
            try
            {
                ...
                B2C r = new B2C();
                r.InitiatorName = "apitest521";
                string pass = "Safaricom111!";
                ...
                byte[] encrypted = rsa.Encrypt(pass2, false);
                string enpass = Convert.ToBase64String(encrypted);


                r.SecurityCredential = enpass;// "";
                r.CommandID = "BusinessPayment";
                r.Amount = 10;
                r.PartyA = "601521";
