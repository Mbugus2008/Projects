    ...
    public class TellerController : ApiController
    {
        ...
        public Results<Teller_Transactions.Teller_Transactions[]> Transactions(string Agent)
        {
            try
            {
                ...
                {
                    Contents = new Teller_Transactions_Service(app.Settings).ReadMultiple(
        ...
        public Results<Teller_Transactions.Teller_Transactions> update(
            Teller_Transactions.Teller_Transactions teller_transactions)
        {
            try
            { teller_transactions.Date_Issued = DateTime.Now;
                ...
                Teller_Transactions_Service tt = new Teller_Transactions_Service(app.Settings);
