...
namespace Client
{
    ...
    public class loan
    {
        ...
        {
            List<Loans.Loans> ll = new List<Loans.Loans>();
            Trans tt = t;
         
            var cl = loanservice.ReadMultiple(new Loans_Filter[] { new Loans_Filter { Criteria = t.Account_No, Field = Loans_Fields.Client_Code } }, null, 0).Where(o => o.Outstanding_Balance > 0 || o.Oustanding_Interest > 0).ToList();
            ll = cl;
            //foreach (var l in cl)
            //{
