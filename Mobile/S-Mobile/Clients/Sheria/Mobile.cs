...
namespace Client
{
    ...
    public class Trans : Results
    {
        ...
        [DataMember]
        public List<Loans.Loans> LoanBalances = null;
        [DataMember]
        ...
        public static Trans Create(Trans t)
        {
            ...
            try
            {
                ...
                if (t.Transaction_Type == 18 || t.Transaction_Type == 19 || t.Transaction_Type == 20)
                {
            ...
            finally
            {
                try
                {
                    //Logging.Logging.LogEntryOnFile(String.Format("{0} Finally {1}", DateTime.Now.ToString(), t.Document_No));
                    ...
                    if (tr != null)
                    {
                        // Logging.Logging.LogEntryOnFile(String.Format("{0} Start saving {1}", DateTime.Now.ToString(), t.Document_No));
                ...
                if (((Trans_Type)t.Transaction_Type) != Trans_Type.Deposit)
                {
                    ...
                    switch ((Trans_Type)t.Transaction_Type)
                    {
                        ...
                        case Trans_Type.Withdrawal:
                            try
                            {
                                if (Dailyamount(t.Account_No, "Withdrawal Complete".ToString()) > setup.Max_Daily_limit)
                                {
                                    t.code = 11;
                                    return;
                                }
 ...
 if (string.IsNullOrEmpty(t.Receipt_No))
        ...
        public static List<Accounts.Accounts> Getaccounts(string tel)
        {
            ...
            try
            {
                acc = Accservice.ReadMultiple(new Accounts.Accounts_Filter[] { new Accounts.Accounts_Filter { Criteria = tel, Field = Accounts.Accounts_Fields.MPESA_Mobile_No },new  Accounts.Accounts_Filter { Criteria = "No", Field = Accounts.Accounts_Fields.Mobile_Blocked } }, null, 1000).ToList();
                if (acc.Count()==0)
                    acc = Accservice.ReadMultiple(new Accounts.Accounts_Filter[] { new Accounts.Accounts_Filter { Criteria = tel, Field = Accounts.Accounts_Fields.Mobile_Phone_No }, new Accounts.Accounts_Filter { Criteria = "No", Field = Accounts.Accounts_Fields.Mobile_Blocked } }, null, 1000).ToList();
                if (acc.Count() == 0)
                    acc = Accservice.ReadMultiple(new Accounts.Accounts_Filter[] { new Accounts.Accounts_Filter { Criteria = tel, Field = Accounts.Accounts_Fields.Phone_No }, new Accounts.Accounts_Filter { Criteria = "No", Field = Accounts.Accounts_Fields.Mobile_Blocked } }, null, 1000).ToList();
        ...
        public static List<Accounts.Accounts> Getaccountsbyid(string id)
        {
            ...
            try
            {
                acc = Accservice.ReadMultiple(new Accounts.Accounts_Filter[] { new Accounts.Accounts_Filter { Criteria = id, Field = Accounts.Accounts_Fields.ID_No }, new Accounts.Accounts_Filter { Criteria = "No", Field = Accounts.Accounts_Fields.Mobile_Blocked } }, null, 1000).ToList();
            }
            catch (Exception ex) { Logging.Logging.ReportError(ex); }
            return acc;
        }
        ...
        public static List<Accounts.Accounts> Getmemberaccounts(string memberno)
        {
            ...
            try
            {
                acc = Accservice.ReadMultiple(new Accounts.Accounts_Filter[] { new Accounts.Accounts_Filter { Criteria = memberno, Field = Accounts.Accounts_Fields.No }, new Accounts.Accounts_Filter { Criteria = "No", Field = Accounts.Accounts_Fields.Mobile_Blocked } }, null, 1000).ToList();
            }
            catch (Exception ex) { Logging.Logging.ReportError(ex); }
            return acc;
        }
        ...
        public static double Balance(string account)
        {
            ...
            try
            {
                ...
                Logging.Logging.LogEntryOnFile(account + "-" + bal.ToString());
            }
            catch (Exception ex)
            {
                Logging.Logging.ReportError(ex);
