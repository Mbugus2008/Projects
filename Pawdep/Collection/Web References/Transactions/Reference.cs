...
namespace Collection.Transactions {
    ...
    public partial class PW_Transactions_Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public PW_Transactions Read(string Transaction_No, string Transaction_Type, string Pawdep_No) {
        ...
        /// <remarks/>
        public void ReadAsync(string Transaction_No, string Transaction_Type, string Pawdep_No) {
            this.ReadAsync(Transaction_No, Transaction_Type, Pawdep_No, null);
        }
        
        /// <remarks/>
        public void ReadAsync(string Transaction_No, string Transaction_Type, string Pawdep_No, object userState) {
